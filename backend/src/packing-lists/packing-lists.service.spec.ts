...
describe("PackingListsService", () => {
  ...
  describe("findByPlan", () => {
    ...
    it("should return null when not found", async () => {
      prisma.packingList.findUnique.mockResolvedValue(null);
  ...
  describe("addItem", () => {
    it("should add an item to packing list", async () => {
      ...
      prisma.packingItem.create.mockResolvedValue(createdItem as any);
  ...
  describe("updateItem", () => {
    it("should update an item", async () => {
      ...
      prisma.packingItem.update.mockResolvedValue(updatedItem as any);
  ...
  describe("removeItem", () => {
    it("should remove an item", async () => {
      prisma.packingItem.delete.mockResolvedValue({ id: 1 } as any);
  ...
  describe("toggleItem", () => {
    it("should toggle isPacked from false to true", async () => {
      ...
      prisma.packingItem.findUnique.mockResolvedValue(item as any);
      prisma.packingItem.update.mockResolvedValue({
        ...item,
        isPacked: true,
      } as any);
  ...
  describe("applyTemplate", () => {
    it("should apply beach template to existing packing list", async () => {
      ...
      prisma.packingItem.create.mockResolvedValue({} as any);
    ...
    it("should create packing list if not exists and apply template", async () => {
      ...
      prisma.packingList.create.mockResolvedValue({ id: 1, planId: 1 } as any);
      prisma.packingItem.create.mockResolvedValue({} as any);
